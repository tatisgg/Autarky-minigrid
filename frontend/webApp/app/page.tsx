      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="flex flex-col md:flex-row items-stretch gap-8">
          ...
          <div className="flex-1 flex items-center">
            <div className="bg-blue-50 p-8 rounded-lg w-full h-full flex flex-col justify-center">
              ...
              <p className="text-gray-700 mb-4">
                ...
                <strong>optimal sizing, dispatch strategies</strong>, and a
                complete <strong>cost analysis</strong>, all in one place.
              </p>
              <div className="flex items-center gap-2 mb-6">
                <Github className="w-5 h-5" />
                <Link
                  href="https://github.com/tatisgg/Autarky-minigrid"
                  target="_blank"
          ...
          <div className="flex-1 flex items-center">
            <div className="bg-blue-50 p-8 rounded-lg w-full h-full flex flex-col justify-center">
              ...
              <p className="text-gray-700 mb-4">
                ...
                sizing, dispatch, and cost analysis across the network.
              </p>
