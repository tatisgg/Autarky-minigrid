...
export default function LoadDemandPage() {
  ...
  useEffect(() => {
    ...
    const sampleData: LoadProfile = {
      ...
      winter: [3.891376272, 3.858637756, 3.963242994, 4.132282962, 4.581515179, 5.162331822, 5.899239976, 8.815176394, 9.263618488, 8.48467442, 8.487606357, 15.40057905, 8.686948972, 9.345073048, 13.98699289, 13.11970489, 10.5067569, 8.918261815, 10.621929, 14.19470429, 16.95455871, 20.47695293, 17.43930468, 10.0685547],
      fall: [3.892483486, 3.97301733, 4.404666059, 4.530259663, 5.036884463, 5.738301168, 6.656826109, 9.947372637, 9.784426994, 8.656192911, 9.092088681, 12.32987813, 9.787916987, 13.82354352, 11.68856198, 12.28662929, 10.64418331, 9.367869155, 12.39465148, 15.44467842, 16.8985169, 16.47170006, 13.68607957, 8.470248611],
      spring: [4.060634208, 4.219408109, 4.961969356, 5.137053824, 5.161052641, 5.426296986, 6.200015786, 8.033416645, 8.068966743, 7.710740108, 7.114797443, 8.88547301, 9.026922076, 9.268428339, 9.438550076, 9.904921441, 9.354557774, 9.22444803, 11.91521833, 15.88198101, 19.38085197, 18.84231053, 14.182495, 9.050987688],
      summer: [3.71310055, 3.850246513, 3.922147577, 4.840740008, 5.504500008, 5.692869978, 6.871955753, 8.40650595, 8.899747882, 8.537873092, 8.002153308, 8.720917636, 9.809463876, 13.25056101, 18.10402886, 15.91283643, 15.58021407, 14.01421239, 16.10392341, 19.83947905, 18.51345079, 17.04587092, 14.06639954, 8.643647509]
    }
            ...
            <div className="border rounded-lg p-4 h-80 bg-white flex items-center justify-center">
              {loadData ? (
                      ...
                      return (
                        <svg key={season} className="absolute inset-0 w-full h-full">
                          <polyline
                            ...
                            stroke={color}
                            strokeWidth="2"
                            points={loadData[season]
                              .map((value: number, index: number) => {
                                const x = 40 + (index / Math.max(1, loadData[season].length - 1)) * 55
                    ...
                    {visibleSeasons.length > 0 && (
                      <div className="absolute top-4 right-4 bg-white p-3 rounded shadow border max-w-32">
                        <div className="text-xs">
                          ...
                          {visibleSeasons.slice(0, 4).map((season, seasonIndex) => (
                ...
                <div className="text-center text-gray-500">
                  ...
                  <p className="text-sm mt-2">(Sample data loaded for demonstration)</p>
                </div>
              )}
            </div>
          </div>
